...
//     (Primero filtramos los disponibles y buscamos el que tiene precio 4.0 directamente)
...
const haySnackPopular: boolean = productos
  .filter(p => p.disponible && p.categoria === "snacks" && p.tags.includes("popular")).length > 0
